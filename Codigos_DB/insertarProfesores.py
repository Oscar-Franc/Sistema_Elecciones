...
def generar_alumno_registro(id_persona):
    ...
    return (
        f"INSERT INTO Profesor (id_persona, no_cuenta, id_organizacion)"
        f"VALUES ('{id_persona}', '{no_cuenta}', '{id_carrera}');"
    )

# Generar las sentencias SQL para los IDs en el rango especificado
sentencias_sql_alumno = [generar_alumno_registro(id_persona) for id_persona in range(5395, 5817)]

# Guardar en archivo SQL (ruta completa)
output_file_path = "/home/oscar/Documentos/Semestre2024B/Sistema_Votacion/Codigos_DB/inserts_prfo_4_uaemex.sql"
